...
**The LLM never computes clinical values.** All thresholds, deltas, risk levels, and dispositions run through deterministic server-owned tool functions. The current suite has 249 tests, including 87 pathway tool tests, a 30-case original decision-tree audit, 30 matching controller cases, and a 6-case June 2026 prototype regression suite that exercises the major Rush hs-TnI branches end to end.
...
| Testing | Vitest (249 tests; 87 pathway tool tests; 30-case tool audit; 30-case controller audit; 6-case prototype regression suite) plus a live production browser audit harness |
